...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'collect'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      interviews: !(function webpackMissingModule() { var e = new Error("Cannot find module 'collect'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())([])
    };
  },
  mounted: function mounted() {
    ...
    this.form.post('/api/v1/my/interviews/').then(function (response) {
      _this.interviews = !(function webpackMissingModule() { var e = new Error("Cannot find module 'collect'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(response);
    });
  },
  computed: {
    techStack: function techStack() {
      return this.interviews.pluck('candidate.technology_stack.id', 'candidate.technology_stack.name');
    }
  },
  methods: {
